...
/*发送数据流*/
-(void)sendData:(NSData *)data attrs:(NSMutableArray*)attrs withName:(NSString *)name toid:(NSString *)msgToId targetType:(MsgType)mTargetType  tag:(long)tag
{
    ...
    {
        [self uploadData:data attrs:attrs withName:name toid:msgToId targetType:mTargetType tag:tag];
  }
}
//使用默认文件服务器 上传图片
-(void)sendImageData:(NSData *)data attrs:(NSMutableArray *)attrs withName:(NSString *)name toid:(NSString *)msgToId targetType:(MsgType)mTargetType tag:(long)tag
{
     ...
     [self sendData:data attrs:attrs withName:name toid:msgToId targetType:mTargetType tag:tag];
}
//使用自备文件服务器 上传图片
...
//组拼一个audio结构
-(void)getAudioMustable:(NSMutableArray *)attrs during:(int)audioLasts
{
...
-(void)uploadData:(NSData *)data attrs:(NSMutableArray*)attrs withName:(NSString *)name toid:(NSString *)msgToId targetType:(MsgType)mTargetType  tag:(long)tag
{
